...
class AlmacendeBebidas:
    def __init__(self):
        ...
        self.pag5 = ttk.Frame(self.control)
        self.control.add(self.pag5, text="Precio Promedio Bebidas")

        self.pag6 = ttk.Frame(self.control)
        self.control.add(self.pag6, text="Cantidad de Bebidas Marca")

        self.pag7 = ttk.Frame(self.control)
        self.control.add(self.pag7, text="Cantidad de Bebidas Clasificación")
        ...
        self.calcularpormarca = tk.Button(self.pag6, text="Calcular", command=self.Cantidad_Marca)
    ...
    def Cantidad_Marca(self):
        ...
        messagebox.showinfo("Cantidad por marca", f"La cantidad de la marca {marca} es: {cantidad}")
    ...
    def Cantidad_Clasificacion(self):
        ...
        messagebox.showinfo("Cantidad por clasificación", f"La cantidad de la clasificacion {clasificacion} es: {cantidad}")
